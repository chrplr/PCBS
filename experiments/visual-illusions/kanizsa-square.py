...
left, right, top, bottom = (W-width)//2, (W+width)//2, (H-height)//2, (H+height)//2 # (0,0) is at the upper left hand corner of the screen.

radius = 50

pygame.draw.circle(screen, RED, (left, top), radius, 0)
pygame.draw.circle(screen, RED, (left, bottom), radius, 0)
pygame.draw.circle(screen, RED, (right, top), radius, 0)
pygame.draw.circle(screen, RED, (right, bottom), radius, 0)
