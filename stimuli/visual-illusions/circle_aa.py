#! /usr/bin/env python
# Time-stamp: <2021-03-10 16:45:38 christophe@pallier.org>
""" Display a circle.
...
import pygame
import pygame.gfxdraw  # antialising library
...
pygame.gfxdraw.filled_circle(screen, center_x, center_y, 100, RED)
pygame.gfxdraw.aacircle(screen, center_x, center_y, 100, BLACK)
