...
Puis insérer et executer la ligne suivante pour afficher les premières lignes de la table _lexique_ :
...
Supposons que vous vouliez extraire les lignes de lexiques correspondant, par exemple, aux mots 'bateau', 'avion', 'maison', 'arbre'. Le code suivant
fait précisemment cela:
...
### Les exoressions régulières

Les expressions regulières, ou regex, sont des “patterns” qui permettent de rechercher des mots ayant certaines propriétés. Vous pouvez utilisez ces regex dans les champs de recherche placés au dessus des colonnes dans les tables affichées sur ce site. Voici quelques exemples d’expressions régulières:
