...
Exercise (\*\*): Read about `Posner’s attentional cueing task <https://en.wikipedia.org/wiki/Posner_cueing_task>`__ and program the experiment. 
  ...
  See a solution in :download:`Posner-attention/posner_task.py <../experiments/xpy_Posner_attention_networks_task/posner_task.py>` (you will need :download:`Posner-attention/right-arrow.png <../experiments/xpy_Posner_attention_networks_task/right-arrow.png>`, :download:`Posner-attention/star.png <../experiments/xpy_Posner_attention_networks_task/star.png>` and :download:`Posner-attention/left-arrow.png <../experiments/xpy_Posner_attention_networks_task/left-arrow.png>`
