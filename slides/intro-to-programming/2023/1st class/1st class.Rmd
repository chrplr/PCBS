...
Resources 2/2 : Online course & Mooc
========================================================
...
## Udemy
>  - Udemy: https://www.udemy.com/python-programming-for-absolute-beginners/                

## Code Academy
>  - Code Academy: Learn Python module: https://www.codecademy.com/learn/learn-python-3
...
- Bash commands to navigate directories (with Gitbash in Windows or a terminal Linux of Mac)
...
- Functions working with strings:
  ...
  - **len()** calculates the length of a function. Example:
    ```{python echo=TRUE}
    greetings = "Hello"
    print(len(greetings))
    ```    
...
========================================================    
  ...
  - It is usually used to store the truth value in logic. Example:
    ```{python echo=TRUE}
    Is_it_Weekend = False
    print(Is_it_Weekend)
    ```
...
- You can use different methods to make your comparisons:
    - **and** 
    - **or**
    - **not**
  
- You can also use comparative expressions:
    - **<** 
    - **>**
    - **<=**
    - **==** tests for equality
