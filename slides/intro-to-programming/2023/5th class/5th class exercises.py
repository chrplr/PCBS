...
rootdir = '/home/dbhenri/Documents/Cours python/PCBS/slides/intro-to-programming/2023/'  # give the starting directory (it depends of your own architecture and operation system)
listdirs(rootdir)
