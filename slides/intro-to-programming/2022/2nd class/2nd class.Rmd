...
- Exercise 1: Lists: list1 = [1,2,3,4,1]
  + Given list1 print their sum 
  + Given list1 print their product 
  + Given list1 print the sum of their squares 
  + Given list1 print the largest number 
  + Given list1 print the second largest
