...
\begin{verbatim}
## 2022-11-15 13:53:11,242 -  DEBUG -  Start of program
\end{verbatim}
...
\begin{verbatim}
## 2022-11-15 13:53:11,254 -  DEBUG -  Call of the function
\end{verbatim}
...
## 0
## 
## 2022-11-15 13:53:11,261 -  DEBUG -  Start of factorial(5%)
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 0, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 1, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 2, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 3, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 4, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  i is 5, total is 0
## 2022-11-15 13:53:11,261 -  DEBUG -  End of factorial(5%)
\end{verbatim}
...
\begin{verbatim}
## 2022-11-15 13:53:11,267 -  DEBUG -  End of program
\end{verbatim}
\end{frame}
...
\begin{verbatim}
## 2022-11-15 13:53:11,523 -  DEBUG -  Start of program
\end{verbatim}
...
\begin{verbatim}
## 2022-11-15 13:53:11,534 -  DEBUG -  Call of the function
\end{verbatim}
...
## 120
## 
## 2022-11-15 13:53:11,540 -  DEBUG -  Start of factorial(5%)
## 2022-11-15 13:53:11,540 -  DEBUG -  i is 1, total is 1
## 2022-11-15 13:53:11,540 -  DEBUG -  i is 2, total is 2
## 2022-11-15 13:53:11,540 -  DEBUG -  i is 3, total is 6
## 2022-11-15 13:53:11,540 -  DEBUG -  i is 4, total is 24
## 2022-11-15 13:53:11,540 -  DEBUG -  i is 5, total is 120
## 2022-11-15 13:53:11,540 -  DEBUG -  End of factorial(5%)
\end{verbatim}
...
\begin{verbatim}
## 2022-11-15 13:53:11,546 -  DEBUG -  End of program
\end{verbatim}
\end{frame}
...
\begin{itemize}
\item
  Logging is very useful for debugging on the long run
\item
  To keep a track of variable of interest in a long program
\item
  Debugging even post mortem
\item
  It is especially efficient when you can have access to the terminal
  (i,e when you program experiment with visual stimuli)
\end{itemize}
\end{frame}

\begin{frame}{Python debugger: PDB 1/}
\protect\hypertarget{python-debugger-pdb-1}{}
\begin{itemize}
\item
...
\includegraphics{/home/henri/Documents/python/course/PCBS/slides/intro-to-programming/2022/8th class/screenPDB.png}
\end{frame}

\begin{frame}[fragile]{Python debugger: PDB 2/}
\protect\hypertarget{python-debugger-pdb-2}{}
\begin{itemize}
\item
...
\begin{frame}{Python debugger: PDB 3/}
\protect\hypertarget{python-debugger-pdb-3}{}
\begin{itemize}
\tightlist
\item
  You can use as well:
...
\item
  \includegraphics{/home/henri/Documents/python/course/PCBS/slides/intro-to-programming/2022/8th class/screenPDB_break.png}
\end{itemize}
\end{frame}
